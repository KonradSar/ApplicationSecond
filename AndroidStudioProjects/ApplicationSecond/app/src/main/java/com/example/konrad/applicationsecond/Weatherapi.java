...
//    @BindView(R.id.toolbarnumberone) Toolbar mojToolbar;
//    @BindView(R.id.goBackk) ImageButton goBackButton;
...
//            tempView.setText("Temperature: " + String.format(Locale.US, "0.2f", f) + "0 C");
//            tempView.setText("Temperature: " + weatherResults.getTemperature() + "0 C");
