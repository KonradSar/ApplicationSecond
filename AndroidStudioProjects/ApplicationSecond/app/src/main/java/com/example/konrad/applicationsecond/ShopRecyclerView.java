...
//                    if (summary.getText().toString().length() >= 28){
//                        NaszeMetody.announceLimit = true;
//                    }
//                    else if (summary.getText().toString().length() < 28){
//                        NaszeMetody.announceLimit = false;
//                    }
//                    if (NaszeMetody.announceLimit){
//                        Toast.makeText(getApplicationContext(), R.string.MAximumCurrenciesNumberInTrolleyIss, Toast.LENGTH_SHORT).show();
//                    }

//                    if (summary.getText().toString().length() >= 39){
//                        NaszeMetody.announceLimit = true;
//                    }
//                    else if (summary.getText().toString().length() < 39){
//                        NaszeMetody.announceLimit = false;
//                    }
//                    if (NaszeMetody.announceLimit){
//                        Toast.makeText(getApplicationContext(), "Maksymalna Ilość Znaków Dla Pojedynczego Zakupu", Toast.LENGTH_SHORT).show();
//                    }
...
//                        if (summary.getText().toString().length() >= 28 && !NaszeMetody.currencyLabelNumberOne.equals(NaszeMetody.menuCurrencies.get(i))) {
...
////                        if (summary.getText().toString().length() >= 28 && !NaszeMetody.currencyLabelNumberTwo.equals(NaszeMetody.menuCurrencies.get(i))) {
//                        if (summary.getText().toString().length() >= 28) {
//                            NaszeMetody.announceLimit = true;
//                        } else if (summary.getText().toString().length() < 28) {
//                            NaszeMetody.announceLimit = false;
...
//                    else {
//                        if (counterForAnotherCurrency2 < 12){
//                            Toast.makeText(getApplicationContext(), "Kwota W Walucie " + NaszeMetody.currencyLabelNumberTwo + " Jest Zbyt Wysoka", Toast.LENGTH_SHORT).show();
//                            summary.setText(String.format("%.2f", NaszeMetody.finalResult)+" PLN");
//                        }
//                        else {
//                            Toast.makeText(getApplicationContext(), "Kwoty Zbyt Wysokie Do Wyświetlenia", Toast.LENGTH_SHORT).show();
//                        }
//                    }
...
//                    for (int i = 0; i < NaszeMetody.menuCurrencies.size(); i++) {
////                        if (summary.getText().toString().length() >= 28 && !NaszeMetody.currencyLabelNumberOne.equals(NaszeMetody.menuCurrencies.get(i)) &&
////                                !NaszeMetody.currencyLabelNumberTwo.equals(NaszeMetody.menuCurrencies.get(i))) {
//                            if (summary.getText().toString().length() >= 28) {
//                            NaszeMetody.announceLimit = true;
//                        } else if (summary.getText().toString().length() < 28) {
//                            NaszeMetody.announceLimit = false;
...
//                    for (int i = 0; i < NaszeMetody.menuCurrencies.size(); i++) {
////                        if (summary.getText().toString().length() >= 28 && !NaszeMetody.currencyLabelNumberOne.equals(NaszeMetody.menuCurrencies.get(i)) &&
////                                !NaszeMetody.currencyLabelNumberTwo.equals(NaszeMetody.menuCurrencies.get(i)) && !NaszeMetody.currencyLabelNumberThree.equals(NaszeMetody.menuCurrencies.get(i))) {
//                            if (summary.getText().toString().length() >= 28) {
//                            NaszeMetody.announceLimit = true;
//                        } else if (summary.getText().toString().length() < 28) {
//                            NaszeMetody.announceLimit = false;
...
//                    Toast.makeText(getApplicationContext(), "Zakupy Walutowe Aktywne", Toast.LENGTH_SHORT).show();
...
//                    new AlertDialog.Builder(ShopRecyclerView.this).setTitle(R.string.warning)
//                            .setMessage(R.string.sendShoppingListQuestion)
//                            .setCancelable(true)
//                            .setPositiveButton(R.string.sendSms, new DialogInterface.OnClickListener() {
//                                @Override
//                                public void onClick(DialogInterface dialog, int which) {
//
//                                    Uri uri2 = Uri.parse("content://contacts");
...
//                            dialog.dismiss();
//                        }
//                    }).setIcon(R.drawable.alert).setNeutralButton(R.string.sendMail, new DialogInterface.OnClickListener() {
//                        @Override
//                        public void onClick(DialogInterface dialog, int which) {
//                            Intent i = new Intent(Intent.ACTION_SEND);
//                            i.setType("message/rfc822");
