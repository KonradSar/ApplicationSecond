package com.example.konrad.firstgame;
...
//https://icons8.com/icon/set/gra/androidL to ikona aplikacji
//Front Desk Bell Sound dzwiek punktu i link http://soundbible.com/2190-Front-Desk-Bell.html
...
public class GraActivity extends AppCompatActivity {
    ...
    public void checkIfStopGame( ){
        if(computerResult==5 || playerResult==5){
            AlertDialog.Builder builder = new AlertDialog.Builder(GraActivity.this, android.R.style.Theme_Material_Dialog_Alert);
    ...
    public void onBackPressed() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(GraActivity.this);
